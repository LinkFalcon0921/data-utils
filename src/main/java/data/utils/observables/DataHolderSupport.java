...
public abstract class DataHolderSupport<H> {
    protected PropertyChangeSupport propertyObserver;

    public DataHolderSupport(){}

    public DataHolderSupport(PropertyChangeSupport propertyObserver) {
